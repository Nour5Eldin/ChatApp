...
@Composable
fun ChatAuthTextField(state: MutableState<String>, errorState: String?, lable: String, trailingIcon: Int?=null, ispassword: Boolean= false){
    Column(modifier = Modifier.fillMaxWidth(),horizontalAlignment = Alignment.CenterHorizontally) {
        ...
        if (errorState !=null){
            Text(
                ...
                modifier = Modifier.padding(horizontal = 32.dp, vertical = 2.dp).align(Alignment.Start)
            )
        }
    }
